      ...
      <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
        ...
        {/* <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center w-full lg:w-auto"> */}
          ...
          <div className="flex items-center gap-2">
            ...
            <Select value={currentLimit.toString()} onValueChange={(value) => handleLimitChange(Number(value))}>
            ...
            {loading ? (
                ...
                >
                  ...
                  <TableCell>
                    <div className="flex items-center">
                      ...
                      <span className="ml-1 text-gray-700">{product.rating || 'N/A'}</span>
                    </div>
                  </TableCell>
              ...
              <TableRow>
                <TableCell colSpan={7} className="text-center py-12">
                  <EmptyHistoryMessage
                    Icon={Package}
                    message={searchQuery ? `No products match "${searchQuery}"` : "No records available in the product catalog"}
                  />
                </TableCell>
              </TableRow>
            )}
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between">
          <div className="text-sm text-gray-600">
            Showing {((currentPage - 1) * currentLimit) + 1} to {Math.min(currentPage * currentLimit, products.length)} of {products.length} products
          </div>
          <Pagination
            page={currentPage}
