...
export function AdminSidebar() {
  ...
  return (
    <Sidebar 
      variant="inset" 
      side="left"
      className="border-r border-gray-200/50"
    >
      <SidebarHeader className="bg-gradient-to-r from-blue-100 to-blue-50 dark:from-blue-900 dark:to-blue-800 border-b border-blue-200/50">
        <SidebarMenu>
          <SidebarMenuItem>
      ...
      <SidebarContent className="bg-blue-50/80 dark:bg-blue-800/80">
        <SidebarGroup>
              ...
              {items.map((item) => (
                <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton 
                    ...
                    className={cn(
                      "group relative mx-2 h-12 rounded-xl transition-all duration-300 hover:scale-[1.02] shadow-sm hover:shadow-md",
                      pathname === item.url 
      ...
      <SidebarFooter className="bg-gradient-to-r from-blue-100 to-blue-50 dark:from-blue-900 dark:to-blue-800 border-t border-blue-200/50">
