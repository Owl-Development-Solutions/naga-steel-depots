...
interface CartItemWithCheckboxProps {
  item: CartItem;
  isPending: boolean;
...
const CartItemWithCheckbox = ({ 
  item, 
  isPending, 
  startTransition,
  isSelected,
  onSelectionChange
}: CartItemWithCheckboxProps) => {
  ...
  return (
    <div className={`flex items-center gap-3 ${!isSelected ? 'opacity-60' : ''}`}>
      <Checkbox
        checked={isSelected}
...
export default CartItemWithCheckbox;
